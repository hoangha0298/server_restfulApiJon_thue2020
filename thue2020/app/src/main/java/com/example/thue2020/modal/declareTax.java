...
public class declareTax {
    ...
    private long minusYourSefl = 0;         // bản thân
    private long minusDependentPerson = 0;  // người phụ thuộc
    private long minusCharity = 0;          // tử thiện
    private long minusInsurance = 0;       // bảo hiểm
